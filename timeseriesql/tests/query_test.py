...
class TestQuery(unittest.TestCase):
    ...
    def test_basic_filter(self):
        ...
        expected_plan = {
            ...
            "filters": [
                {
                    "left": {"type": "var", "name": "x", "labels": ["label1"]},
                    "op": "==",
                    "right": {"type": "string", "value": "prod"},
                }
            ],
            "group": None,
            "variables": [{"name": "x", "labels": []}],
    ...
    def test_binary_operations(self):
        ...
        expected_plan = {
            "metrics": ["test"],
            "calc": [{'left': 'x', 'opname': 'BINARY_MULTIPLY', 'right': 100}],
            "filters": [
                {
                    "left": {"type": "var", "name": "x", "labels": ["label1"]},
                    "op": "==",
    ...
    def test_multiple_binary_operations(self):
        ...
        expected_plan = {
            "metrics": ["test"],
            "calc": [{'left': 'x', 'opname': 'BINARY_MULTIPLY', 'right': 100},{'left': None, 'opname': 'BINARY_MULTIPLY', 'right': 'x'}],
            "filters": [
                {
                    "left": {"type": "var", "name": "x", "labels": ["label1"]},
                    "op": "==",
    ...
    def test_multiple_generators(self):
        ...
        expected_plan = {
            ...
            "calc": [{'left': 'x', 'opname': 'BINARY_SUBTRACT', 'right': 'y'}],
            "filters": [],
            "group": None,
    ...
    def test_aggregation_functions(self):
        ...
        expected_plan = {
            "metrics": ["test"],
            "calc": [{'args': [{'labels': [], 'name': 'x'}],'kwargs': {},'name': 'mean'}],
            "filters": [
                {
                    "left": {"type": "var", "name": "x", "labels": ["label1"]},
                    "op": "==",
                ...
                "filters": [
                    {
                        "left": {"type": "var", "name": "x", "labels": ["label1"]},
                        "op": "==",
                        "right": {"type": "string", "value": filters[i]},
                    }
                ],
                "group": None,
                "variables": [{"name": "x", "labels": []}],
